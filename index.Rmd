...
.pull-right[
```{r predprobs, echo = FALSE, out.width = "80%", fig.align = "center"}
...
bnab_tab <- tibble::tibble(
  ...
  `Clinical Trial(s)` = c("HVTN 703,704", "HVTN 121,128", "HVTN 130", "HVTN 130", "HVTN 130", "HVTN 130", "HVTN 130", "HVTN 129"),
...
.pull-left[
* specify the operating system for the container
...
```{r data-example-dockerfile-6, echo = FALSE, out.width = "90%", fig.align = "center"}
...
```{r data-example-dockerfile-7, echo = FALSE, out.width = "90%", fig.align = "center"}
...
&zwj;Stacking .small[ [e.g., Wolpert (1992), _Neural Networks_] ]:
...
&zwj;Super learning (SL) .small[ [van der Laan et al. (2007), _Stat Appl Genet Mol Biol_] ]:
...
1. Studying .blue1[all single bnAbs] in CATNAP
...
2. Studying .green[combination regimens] with sufficient data
...
.pull-left[
Overall median CV-AUCs:
* Hake and Pfeifer (2017): 0.71
* Rawi et al. (2019): 0.84
* SLAPNAP: 0.80
]
...
## Performance on combination regimens

```{r multi-nab, echo = FALSE, out.width = "75%", fig.align = "center"}
...
[source code](https://github.com/benkeser/slapnap) | [Docker image](https://hub.docker.com/r/slapnap/slapnap)
